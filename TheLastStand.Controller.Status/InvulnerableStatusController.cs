...
public class InvulnerableStatusController : StatusController
{
	public InvulnerableStatusController(TheLastStand.Model.Unit.Unit unit, StatusCreationInfo statusCreationInfo)
	{
		base.Status = new InvulnerableStatus(this, unit, statusCreationInfo);
	}
	...
	public override StatusController Clone()
	{
		...
		return new InvulnerableStatusController(base.Status.Unit, statusCreationInfo);
	}
