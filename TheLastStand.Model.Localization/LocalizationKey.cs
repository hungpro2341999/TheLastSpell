...
public static class LocalizationKey
{
	...
	{
		public const string ApocalypseLevelRewardLevelsCompleted = "ApocalypseLevelReward_LevelsCompleted";

		public const string ApocalypseLevelRewardNewModifiers = "ApocalypseLevelReward_NewModifiers";

		public const string ApocalypseLevelRewardVictoryScreenUnlockedModifiers = "ApocalypseLevelReward_VictoryScreenUnlockedModifiers";

		public const string ApocalypseModifierDropdownStepOff = "ApocalypseModifier_DropdownStep_Off";

		public const string ApocalypseModifierDropdownStepOn = "ApocalypseModifier_DropdownStep_On";

		public const string ApocalypseModifierTitlePrefix = "ApocalypseModifierTitle_";

		public const string ApocalypseModifierDescriptionPrefix = "ApocalypseModifierDescription_";

		public const string ApocalypseModifierTitleLocked = "ApocalypseModifier_Title_Locked";
	}
	...
	{
		public const string FilterNamePrefix = "FilterName_";
	}
	...
	public static class Skill
	{
		...
		public const string SkillFlipFeedbackText = "SkillFlip_FeedbackText";
	...
	public static class Race
	{
		...
		public const string RaceMinStatBoundaryWithModifier = "RaceTooltip_MinStatBoundaryWithModifier";

		public const string RaceMaxStatBoundaryWithModifier = "RaceTooltip_MaxStatBoundaryWithModifier";
	}
