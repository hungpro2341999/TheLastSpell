...
public class SetBuildingsNotDemolishableApocalypseEffectDefinition : ApocalypseEffectDefinition
{
	public List<string> BuildingsIds { get; private set; }

	public SetBuildingsNotDemolishableApocalypseEffectDefinition(XContainer container, Dictionary<string, string> tokenVariables = null)
